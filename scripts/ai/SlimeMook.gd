...
@export var detect_radius: float = 180.0
...
func _ready() -> void:
	...
	print("[AI Ready] SlimeMook initialized in PATROL state.")
...
func take_damage(amount: float) -> void:
	if current_state == AIState.DEAD:
		return
	current_hp -= amount
	print("[AI Damage] SlimeMook took ", amount, " damage. HP remaining: ", current_hp)
	if current_hp <= 0:
